    ...
    <SafeAreaView style={{ flex: 1 }}>
      <ScrollView>
        ...
        <View
          ...
          <Text style={[styles.textBlackMedium, { textAlign: 'center' }]}>
        ...
        <View
          ...
          <View style={{ alignItems: 'center', justifyContent: 'center' }}>
            <Text style={[styles.textBlackMedium, { textAlign: 'justify' }]}>
              Com o UrbanEye, você tem acesso a informações detalhadas sobre os
              riscos da sua região. Nossa equipe de desenvolvedores está
              comprometida em fornecer dados precisos e atualizados para ajudar
              você a identificar áreas de risco e tomar decisões informadas.
              Experimente uma abordagem que prioriza sua segurança e bem-estar,
              mantendo você informado sobre os riscos ao seu redor. Mantenha-se
              seguro e protegido com o UrbanEye!
            </Text>
          </View>
        </View>
        ...
        <View
          ...
          <View style={styles.containerCenter}>
            <Text style={[styles.textBlackMedium, { textAlign: 'justify' }]}>
              ...
              manter nossos mapas atualizados. Nossa equipe garante que todas as
              preocupações sejam ouvidas e atendidas quando possível, promovendo
              um ambiente responsivo e de apoio.
            </Text>
          </View>
        </View>

        <View style={[styles.backgroundverdeEscuro, { marginTop: 40 }]}>
          <ImageBackground
